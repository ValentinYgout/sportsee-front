...
import ObjectiveCompletion from "../../components/objectiveCompletion"
import SessionDuration from "../../components/sessionDuration"
import VerticalNav from '../../components/verticalNav';
import Card from '../../components/Card';
import Hello from '../../components/Hello';
import { urlApi } from '../../const/urlApi';
import { urlApiMock } from '../../const/urlDatamock';
...
const Dashboard = () => {
  ...
  const [activityTypesData, setActivityTypesData] = useState(null);
  const fetchContextGlobal = useContext(ApiContext)
  const  fetchContext= fetchContextGlobal.apiToUse
  const { userId } = useParams();
  const Url = fetchContext == "api" ? urlApi : urlApiMock
  ...
  const fetchUserData = async (userId) => {
    try {
      const [
        ...
        fetchData(Url.userActivityData(userId)),
        fetchData(Url.userAverageSessionData(userId)),
        fetchData(Url.userActivityTypesData(userId)),
        fetchData(Url.userMainData(userId))
      ]);
  
      setDailyActivityData(dailyActivityData);
      setSessionDurationData(sessionDurationData);
  ...
  return (
    <div className='dashboard-container'>
      ...
      <div className="dashboard-content">
        ...
        {userMainData &&
          <Hello
            name={userMainData.userInfos.firstName}
          />
        }
        <div className="graphs-and-cards">
          ...
          <div className="graphs">
            ...
            dailyActivityData &&
              ...
              <DailyActivity sessions={dailyActivityData.sessions} />
              
            }
            <div className="bottom-graphs">
              {sessionDurationData &&
                <SessionDuration sessions={sessionDurationData.sessions} />
              }
              {activityTypesData &&
                <ActivityTypes data={activityTypesData} />
              }
              {userMainData &&
                <ObjectiveCompletion data={userMainData.score} />
              }
            </div>
          </div>
          {userMainData &&
            <div className='infocards'>
              ...
              <Card
                ...
                name="Calories"
                value={userMainData.keyData.calorieCount + "kCal"}
              />
              <Card
                image={
                  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                name="Glucides"
                value={userMainData.keyData.carbohydrateCount + "g"}
              />
              <Card
                image={
                  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                name="Lipides"
                value={userMainData.keyData.lipidCount + "g"}
              />
              <Card
                image={
                  <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                name="Proteines"
                value={userMainData.keyData.proteinCount + "g"}
              />
